...
class mcCommands extends DrushCommands {
  ...
  public function mc() {
    ...
    try {
      ...
      // 例外が発生した場合の処理
      $this->output()->writeln("No1 An error occurred: {$e->getMessage()}");
    }
    ...
    try {
      ...
      // 例外が発生した場合の処理
      $this->output()->writeln("No2 An error occurred: {$e->getMessage()}");
    }
    ...
    try {
      ...
      // 例外が発生した場合の処理
      $this->output()->writeln("No3 An error occurred: {$e->getMessage()}");
    }
    ...
    try {
      ...
      // 例外が発生した場合の処理
      $this->output()->writeln("No4 An error occurred: {$e->getMessage()}");
    }
  }
}